...
Aplicação em ReacJS utilizando Typescript, Hooks, API Context e Styled-Component, em uma arquitetura limpa, ou quase. A aplicação consiste em alimentar uma tabela com os planetas do universo StarWars e assim é possível tanto filtrar os dados quanto também ordenar por colunas.

## Inicializar aplicação
A aplicação rodará no http://localhost:8080.
